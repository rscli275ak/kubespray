...
prepare_wordpress(){
echo
echo 'TASK - prepare directories for wordpress'
sudo mkdir /home/vagrant/wordpress
sudo chown -R vagrant:vagrant /home/vagrant/wordpress
}
